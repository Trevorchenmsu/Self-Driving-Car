...
// It was obtained by measuring the radius formed by running the 
// vehicle in the simulator around in a circle with a constant 
...
vector<double> MPC::Solve(VectorXd state, VectorXd coeffs) {
  ...
  /*************************** Set lower and upper limits for constraints ************************************************/
